...
const Preview = (props) => {
  return (
    <div className='bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl  w-full p-5 border border-slate-500 shadow-lg flex flex-col gap-3'>
     ...
     <div className='pb-2 text-center text-2xl break-words'>
