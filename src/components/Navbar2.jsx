...
const Navbar2 = () => {
  return (
     <div className="w-full px-6 py-4 bg-gray-900 shadow-md flex items-center justify-between mb-10">
        ...
        <Link to='/home'   className="px-4 py-2 rounded-lg text-lg font-medium  text-gray-300  hover:text-white  hover:bg-gray-800  transition-all  duration-200" >Home</Link>
