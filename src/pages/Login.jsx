...
const Login = () => {
  return (
    <div className=' h-screen w-full bg-gray-950 flex items-center justify-center text-shadow-slate-50'>
        ...
        <div className='bg-gray-800 w-80 h-100 rounded-xl shadow-xl'>
  ...
  <label
    htmlFor="email"
    className="block font-medium mb-1 text-slate-500"
  >
    Email Address
  </label>
  ...
  <input
    ...
    className="w-full border-b border-gray-300 px-2 py-2 rounded-md
...
>
  Submit
           ...
           <div className='mt-8 flex items-center justify-between'>
            ...
            <button className='mt--6 w-full flex items-center justify-center bg-gray-700 border border-gray-600 py-2 
